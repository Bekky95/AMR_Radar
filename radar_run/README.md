#Notiz von Ibo:
dieses Repo pullen: https://github.com/ibaiGorordo/AWR1642-Read-Data-Python-MMWAVE-SDK-2/tree/master
danach die file von mir in DaFile/readData_AWR1642.py in Projekt einfügen (die im Projekt rauswerfen)
