...
def update():
    ...
    if dataOk:
        if detObj.get("numObj", 0) > 0:
            ...
            filtered_x, filtered_y = main.visualizationFilter.apply(raw_x, raw_y)
            main.s.setData(filtered_x, filtered_y)
        else:
            ...
            filtered_x, filtered_y = main.visualizationFilter.apply([], [])
            main.s.setData(filtered_x, filtered_y)
